...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		for (int oneHopCandidate = 0; oneHopCandidate < getNumVertices(); oneHopCandidate++) {
			if (adjMatrix[v][oneHopCandidate] != 0) {
				for (int twoHopCandidate = 0; twoHopCandidate < getNumVertices(); twoHopCandidate++) {
					if (adjMatrix[oneHopCandidate][twoHopCandidate] != 0) {
						twoHops.add(twoHopCandidate);
					}
				}
			}
		}
